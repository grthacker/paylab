                                        ...
                                        @forelse($logs as $log)
                                            <tr>
                                                ...
                                                <td data-label="@lang('Amount')">
                                                    <strong>{{ getAmount($log->amount) }}
                                                        {{ __($general->cur_text) }}</strong>
                                                </td>
                                                <td>
                                                    @if ($log->status == 1)
                                                        <span
                                                            class="badge badge-success style--light">@lang('Complete')</span>
                                                    @elseif($log->status == 2)
                                                        <span
                                                            class="badge badge-warning style--light">@lang('Pending')</span>
                                                    @elseif($log->status == 3)
                                                        <span
                                                            class="badge badge-danger style--light">@lang('Rejected')</span>
                                                    @endif

                                                    @if ($log->admin_feedback != null)
                                                        <a href="javascript:void(0)"
                                                            class="icon-btn bg-primary text-white detailBtn"
                                                ...
                                                <td data-label="@lang('Details')">
                                                    <a href="javascript:void(0)"
                                                        class="icon-btn bg-primary text-white approveBtn"
                                                        data-info="{{ $details }}" data-id="{{ $log->id }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="">
                        <p class="" style="font-weight: bold; color:black;">@lang('Amount') : <span
                                class="withdraw-amount "></span></p>
                        <p class="" style="font-weight: bold; color:black;">@lang('Charge') : <span
                                class="withdraw-charge "></span></p>
                        <p class="" style="font-weight: bold; color:black;">@lang('After Charge') : <span
                                class="withdraw-after_charge"></span></p>
                        <p class="" style="font-weight: bold; color:black;">@lang('Conversion Rate') : <span
                                class="withdraw-rate"></span></p>
                        <p class="" style="font-weight: bold; color:black;">@lang('Payable Amount') : <span
                                class="withdraw-payable"></span></p>
                    </div>
            ...
            $('.approveBtn').on('click', function() {
                ...
                if (singleInfo) {
                    modal.find('.withdraw-detail').html(
                        `<br><strong class="my-3" style="font-weight: bold; color:black;">@lang('Payment Information')</strong>  ${singleInfo}`
                        );
                } else {
