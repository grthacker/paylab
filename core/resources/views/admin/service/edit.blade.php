                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="w-100">@lang('Select Service') <span
                                                    ...
                                                    <select name="category_id" id="category_id" class="form-control"
                                                        ...
                                                        @foreach ($categories as $data)
                                                            <option
                                                                ...
                                                                data-origin="{{ $data->field_name }}">{{ __($data->name) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="w-100">@lang('Processing Time') <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="delay" value="{{ $service->delay }}"
                                ...
                                <div class="content w-100 pl-0 mb-4">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="w-100">@lang('Service Name')<span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="w-100">@lang('Icon') <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="0"
                                                    name="fixed_charge" value="{{ getAmount($service->fixed_charge) }}"
                                                    required="" />
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required="" placeholder="0"
                                                    name="percent_charge"
                                                    value="{{ getAmount($service->percent_charge) }}">
                                                <div class="input-group-append">
                                                        ...
                                                        <div class="col-md-12 user-data">
                                                            <div class="form-group">
                                                                <div class="input-group mb-md-0 mb-4">
                                                                    ...
                                                                    <div
                                                                        class="col-md-{{ $loop->first == true ? 4 : 3 }} mt-md-0 mt-2">
