                                ...
                                @forelse($categories as $index => $data)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="javascript:void(0)" class="icon-btn eidtBtn" data-toggle="tooltip"
                                                data-original-title="@lang('Edit')" data-id='{{ $data->id }}'
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <input type="text" id="field_name" value="{{ old('field_name') }}" class="form-control"
                                    name="field_name">
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <input type="text" id="name2" value="{{ old('name') }}" class="form-control"
                                    name="name" required>
                            </div>
                            <div class="col-lg-12 form-group">
                                ...
                                <input type="text" id="field_name2" value="{{ old('field_name') }}"
...
@push('breadcrumb-plugins')
    <a class="btn btn-sm add-btn btn--primary box--shadow1 text--small" href="javascript:void(0)"><i
